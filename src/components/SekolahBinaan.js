...
const SekolahCard = ({ sekolah }) => (
  <div className='shadow-xl flex xl:flex-row flex-col xl:text-left text-center md:p-16 p-8 xl:gap-8 transition ease-in-out duration-300 delay-75 hover:-translate-y-1 hover:scale-110'>
    <img
      src={sekolah.logo}
      alt={sekolah.name}
